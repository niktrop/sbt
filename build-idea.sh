...
TEMP_SBINARY=$(mktemp -d)
(cd $TEMP_SBINARY && jar -xf $HOME/.ivy2/cache/org.scala-tools.sbinary/sbinary_2.11/jars/sbinary_2.11-0.4.2.jar)
...
cp interface/target/interface-0.13.5.jar $INTERFACE
